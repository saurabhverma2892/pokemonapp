...
},{"./modules/main/module":29,"backbone":"backbone","backbone.marionette":"backbone.marionette","jquery":"jquery"}],26:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../models/pokemons":28,"backbone":"backbone"}],27:[function(require,module,exports){
var Backbone = require('backbone');
var Marionette = require('backbone.marionette');
...
},{"../../../datas.json":1,"./collections/pokemons":26,"./views/header/header":32,"./views/pokemoncollection/pokemoncollection":38,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],28:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":"backbone"}],29:[function(require,module,exports){
...
},{"./controller":27,"./router":30,"./views/layout/layout":34,"backbone.marionette":"backbone.marionette"}],30:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"backbone.marionette":"backbone.marionette"}],31:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"header__cover\">\n	<h1 class=\"header__logo\">Pokemons</h1>	\n</div>";
},"useData":true});
...
},{"./header.hbs":31,"backbone.marionette":"backbone.marionette","jquery":"jquery"}],33:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"header-container\"></div>\n<div class=\"main-container\">\n    \n</div>\n";
},"useData":true});
...
},{"./layout.hbs":33,"backbone.marionette":"backbone.marionette"}],35:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<td><div class=\"\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"_id") || (depth0 != null ? lookupProperty(depth0,"_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data,"loc":{"start":{"line":1,"column":18},"end":{"line":1,"column":25}}}) : helper)))
    + "</div></td>\n<td><div>"
    + alias4(((helper = (helper = lookupProperty(helpers,"dexId") || (depth0 != null ? lookupProperty(depth0,"dexId") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dexId","hash":{},"data":data,"loc":{"start":{"line":2,"column":9},"end":{"line":2,"column":18}}}) : helper)))
    + "</div></td>\n<td><div class=\"normal-view\">"
    ...
    + "</div><div class=\"edit-view\"><input type=\"text\" placeholder=\"name\" name=\"name\" class=\"name\"></div></td>\n<td><div class=\"normal-view\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"type1") || (depth0 != null ? lookupProperty(depth0,"type1") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"type1","hash":{},"data":data,"loc":{"start":{"line":4,"column":29},"end":{"line":4,"column":38}}}) : helper)))
    + "</div><div class=\"edit-view\"><input type=\"text\" placeholder=\"type1\" name=\"type1\" class=\"type1\"></div></td>\n<td><div class=\"normal-view\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"generation") || (depth0 != null ? lookupProperty(depth0,"generation") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"generation","hash":{},"data":data,"loc":{"start":{"line":5,"column":29},"end":{"line":5,"column":43}}}) : helper)))
    + "</div><div class=\"edit-view\"><input type=\"text\" placeholder=\"generation\" name=\"generation\" class=\"generation\"></div></td>\n<td><div>"
    + alias4(((helper = (helper = lookupProperty(helpers,"__v") || (depth0 != null ? lookupProperty(depth0,"__v") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"__v","hash":{},"data":data,"loc":{"start":{"line":6,"column":9},"end":{"line":6,"column":16}}}) : helper)))
    + "</div></td>\n<td><div class=\"normal-view\"><button class=\"uk-button uk-button-warning edit-button\">Edit</button><button class=\"uk-button uk-button-danger delete-button\">Delete</button></div><div class=\"edit-view\"><button class=\"uk-button uk-button-primary save-button\">Save</button><button class=\"uk-button uk-button-danger cancel-button\">Cancel</button></div></td>\n	";
},"useData":true});
...
},{"./pokemon.hbs":35,"backbone.marionette":"backbone.marionette"}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<table>\n    <thead>\n        <tr>\n            <th>_id</th>\n            <th>dexId</th>\n            <th>name</th>\n            <th>type1</th>\n            <th>generation</th>\n            <th>__v</th>\n            <th>Actions</th>\n        </tr>\n    </thead>\n    <tbody class=\"tbody-hook\">\n\n    </tbody>\n    <tbody>\n        <tr>\n            <td>+ Add New</td>\n            <td><div><input type=\"text\" name=\"dexid\" placeholder=\"dexId\" id=\"dexId\" required></div></td>\n            <td><div><input type=\"text\" name=\"name\" placeholder=\"name\" id=\"name\" required></div></td>\n            <td><div><input type=\"text\" name=\"type1\" placeholder=\"type1\" id=\"type1\" required></div></td>\n            <td><div><input type=\"text\" name=\"generation\" placeholder=\"generation\" id=\"generation\" required></div></td>\n            <td></td>\n            <td><button class=\"uk-button uk-button-primary\" id=\"addButton\" type=\"button\">Add</button></td>\n        </tr>\n    </tbody>\n</table>\n";
},"useData":true});
...
},{"../../collections/pokemons":26,"../../models/pokemons":28,"../pokemon/pokemon":36,"./pokemoncollection.hbs":37,"backbone.marionette":"backbone.marionette","underscore":24}]},{},[25]);
